...
<div class="d-flex">
    <div class="bg-dark text-white" style="width: 250px; min-height: 100vh;">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link text-white" href="${pageContext.request.contextPath}/admin/message/list"><i class="fas fa-envelope me-2"></i>消息中心</a></li>
                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                            <div>
                                <a href="${pageContext.request.contextPath}/admin/message/list" class="text-white me-2">
                                        ...
                                        <c:choose>
                                            <c:when test="${msg.senderId == sessionScope.user.userId}">
                                                <div class="d-flex justify-content-end mb-3">
                                                    <div class="bg-info text-white rounded-3 p-3" style="max-width: 70%;">
                        ...
                        <div class="card-footer">
                            <form action="${pageContext.request.contextPath}/admin/message/send" method="post" class="d-flex gap-2">
